...
// @MainActor zorgt dat alle updates automatisch op de UI-thread gebeuren.
// Dit lost de "non-sendable" waarschuwingen op en maakt DispatchQueue overbodig.
@MainActor
class Web3Manager: ObservableObject {
    ...
    func connect() async {
        // Geen DispatchQueue meer nodig door @MainActor
        self.isLoading = true
